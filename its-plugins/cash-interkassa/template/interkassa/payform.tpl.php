<?php if(!$fieldsOnly):?><form id="payment" name="payment" method="post" action="<?=$formAction?>" enctype="utf-8"><?php endif?>
	...
	<?php endif?>
<?php if(!$fieldsOnly):?><button>Оплатить</button></form><?php endif?>