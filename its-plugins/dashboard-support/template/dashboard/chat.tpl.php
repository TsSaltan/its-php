            ...
            <div class="col-lg-12">
                ...
                if($isClosed){
                    if($chatRole == 'operator'){
                        echo $this->uiAlert('Данный диалог закрыт. Пользователь не может отвечать.', 'warning');
                    } else {
                        echo $this->uiAlert('Данный диалог закрыт оператором. Чтоб задать вопрос, откройте новое обращение.', 'warning');
                    }
                } 
                ?>
