...
<?uiCollapsePanel('Настройки внешнего вида', function() use ($current_theme, $themes, $siteName, $siteIcon, $siteHome){
    ...
    <div class="form-group">
        <label>Иконка сайта или ссылка на изображение</label>

        <div class="row" style="overflow-y: scroll; max-height:90px; opacity: 0.89">
        ...
        <input class="form-control" name="siteicon" value="<?=$siteIcon?>"/>
    </div>
